...
type Handler = func(s *BsdSocket, dbEngine dbengine.DBEngine)

func NewEventLoop(s *BsdSocket) (*EventLoop, error) {
	/*
...
func (eventLoop *EventLoop) Handle(handler Handler, dbEngine dbengine.DBEngine) {
	/*
